          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-center items-center space-x-4 text-white/80">
                ...
                <span className="text-xl md:text-2xl font-mono tracking-widest">COMPUTER ENGINEERING STUDENT</span>
                <Code className="w-6 h-6" />
              </div>
              
              <p className="text-lg md:text-xl text-white/60 font-mono max-w-3xl mx-auto leading-relaxed tracking-wide">
                [SYSTEM_STATUS: ONLINE] | BUILDING MOBILE & BACKEND APPLICATIONS WITH PRECISION
              </p>
            </div>
          </div>
